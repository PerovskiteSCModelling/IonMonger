...
[chi, delta, G, R, lambda, lam2, Rr, Rl, N, Kn, Kp, NE, lamE2, KE, kE, ...
    rE, NH, lamH2, KH, kH, rH, DI, nc, pc, ARs, Rsp, pbi, SPinv,SPS, SEinv, ...
    ...
    = struct2array(params,{'chi','delta','G','R','lambda','lam2','Rr', ...
                           ...
                           'pc','ARs','Rsp','pbi', 'SPinv', 'SPS','SEinv', ...
                           'omegE', 'SHinv', 'omegH', 'AE', 'AH', 'phidisp'});
...
FP = nnz(DI)*lambda*(Av*(P.*(1-SPS(P)))).*(Dx*(SPinv(P)+phi)); % negative anion vacancy flux
