...
B(1:NE-1,1) = (LoE*[sol_init(4*N+NE+5:4*N+2*NE+4); sol_init(2*N+3)] ...
...
B(NE,1) = dx(1)*(1/2-sol_init(1)/3-sol_init(2)/6 ...
        ...
        +sol_init(2*N+3)/3-1/2)/lamE2; % continuity
...
B(N+NE,1) = dx(end)*(1/2-sol_init(N)/6-sol_init(N+1)/3 ...
        ...
        +rH*dxH(1)*(1/2-sol_init(4*N+4)/3 ...
        -sol_init(4*N+2*NE+NH+5)/6)/lamH2; % continuity
B(N+NE+1:N+NE+NH-1,1) = (ddH-LoH*[sol_init(4*N+4); ...
