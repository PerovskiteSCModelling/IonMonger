...
[Rl, Rr, AH, AE, omegH, omegE, SHinv, SEinv] = struct2array(params,{...
    'Rl','Rr', 'AH', 'AE', 'omegH', 'omegE', 'SHinv', 'SEinv'});
res = [yb(1)-AH/omegH*exp(SHinv(omegH)); ...
       ya(2)+Rl(1,ya(1)); ...
       ya(3)-AE/omegE*exp(SEinv(omegE)); ...
       yb(4)+Rr(yb(3),1)];
end
