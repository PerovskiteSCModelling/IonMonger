...
Plim  = 4.0e25;           % limiting density of ion vacancies (m-3) (can choose inf)
...
nonlinear = 'Drift'; % non-linear term in Ion Vacancy flux. Choose from 'Drift' or 'Diffusion' or 'Neither' if Plim specified.
